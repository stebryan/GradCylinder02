class unitSystem {
    constructor(s, u, unit, conversion) {
        ...
        this.max = floor(1000 / s); // max number of major units based on scale
    ...
    showTics() {
        ...
        for (let i = 0; i < this.max; i++) {
            ...
            textFont(Chewy);
            if (largeTic < 690) {
                rect(295 * width / 1000, largeTic * width / 700, 18 * width / 700, 2); // Draw major ticks
                text(largeText, 275 * width / 1000, (largeTic + 5) * width / 700); // Display unit labels
            }
